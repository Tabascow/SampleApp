angular.module('User', []).factory('AuthenticationService', function() {
    var auth = {
...
angular.module('User').factory('TokenInterceptor', function ($q, $window, $location, AuthenticationService) {
    return {
